  ...
  ~thread_pool() {
    {
      ...
      stop_ = true;
      // if there are still tasks in task_queue_, they will get destroyed
      // without having the chance to be executed, resulting in broken_promise
      // exception being stored into them, which is fine
    }
    condvar_.notify_all();
