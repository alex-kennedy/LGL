...
class VoxelInteractionHandler {
 ...
 public:
  ...
  VoxelInteractionHandler(const VIH_& v) { VIH_::copy(v); }
  ...
  void sameVoxelInteractions() const { VIH_::sameVoxelInteractions(*current); }
  ...
  bool operator==(const VIH_& v) const { return id_ == v.id_; }
