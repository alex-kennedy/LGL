...
class ParticleContainer {
 ...
 public:
  ...
  bool operator==(const PC_& pc) const { return particles_ == pc.particles_; }

  Particle& particle(size_type entry) { return particles_[entry]; }

  Particle& operator[](size_type entry) { return PC_::particle(entry); }
